...
class UnaryServicer(object):
    ...
    def GetServerResponse(self, request, context):
        ...
        """
        print('___UnaryServicer/GetServerResponse___')
...
def add_UnaryServicer_to_server(servicer, server):
    print('___unary_pb2_grpc.py/add_UnaryServicer_to_server___')

    print('servicer = {}, server = {}'.format(servicer, server))
...
class Unary(object):
    ...
    def GetServerResponse(request,
            ...
            timeout=None,
            metadata=None):
        print('___Unary/GetServerResponse___')
